...
url_m3u8 = "https://salam-mskm9-2.rutube.ru/dive/river-5-515.rutube.ru/g-G5fbla4D0c_GlaQ8Yw_A/stream/genetta-532.ost.rutube.ru/Bf1s4eNUnwfur99kDiLwuw/1735971924/88f6485ee28d56daf13302ac6fe3d931/1080p_stream.m3u8"
...
# -vf crop=ширина:высота:x:y 1920:1080 TODO: надо заранее знать откуда вырезать и размер выреза! 353:958- точка, откуда вырезаем 1474:50 - итоговый размер
command0 = f"c:/ffmpeg/bin/ffmpeg.exe -i \"{url_m3u8}\" -vf \"fps=1/14,crop=1474:50:353:958\" {screenshots_path} -hide_banner"
# print(command0)
